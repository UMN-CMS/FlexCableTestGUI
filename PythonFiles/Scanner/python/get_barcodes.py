...
def scan():
    proc = subprocess.Popen('{}/PythonFiles/Scanner/bin/runScanner'.format('/home/hgcal/FlexCableTestGUI/FlexCableTestGUI'), stdout=subprocess.PIPE, preexec_fn=set_pdeathsig(signal.SIGTERM))
