...
class SplashScene(tk.Frame):
    ...
    def initialize_GUI(self, parent, master_frame):
        ...
        img_bethel_logo = Image.open("{}/PythonFiles/Images/Bethel_Logo.png".format('/home/hgcal/FlexCableTestGUI/FlexCableTestGUI'))
        ...
        # Creating UMN Logo
        img_umn_logo = Image.open('{}/PythonFiles/Images/UMN_Logo.png'.format('/home/hgcal/FlexCableTestGUI/FlexCableTestGUI'))
